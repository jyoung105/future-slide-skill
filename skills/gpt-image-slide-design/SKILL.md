...
description: Strict GPT image slide-style extraction skill. Converts one or more reference slide images into a reusable DESIGN.md for future image deck generation. Focuses on presentation design, not semantic content.
---

# GPT IMAGE SLIDE DESIGN — EXTRACT `DESIGN.md` FROM REFERENCE SLIDE IMAGE
